function longestSeqContainedIn(a, b) { // Thanks Node!
...
class Util {
  ...
  longestSeqCobtainedIn(ownStack, errStack) {
    return longestSeqContainedIn(ownStack, errStack);
  }
  enhanceStackTrace(err, own) { // Kinda copied the following method from Node :)
